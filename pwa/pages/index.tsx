...
const Welcome = () => (
  <div className="w-full overflow-x-hidden">
        ...
        <div className="flex flex-1 flex-col items-center text-center | md:text-left md:items-start">
          ...
          <div className="flex justify-center flex-wrap | lg:justify-start lg:grid lg:gap-5 lg:grid-cols-2">
            ...
            >
              Books
              <div
                className="absolute left-full top-0 w-7 h-full bg-cyan-200 transition-all flex p-1 justify-center items-center group-hover:-translate-x-full">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
    ...
    <div
      className="bg-white text-center pb-4 | md:shadow-md md:px-0.5 md:py-4 md:grid md:grid-cols-1 md:gap-3 md:fixed md:top-1/2 md:-right-1 md:-translate-y-1/2 md:portrait:bottom-4 md:portrait:top-auto md:portrait:translate-y-0">
      <h2
        className="text-black text-md font-bold mb-2 | md:text-cyan-700 md:font-normal md:uppercase md:text-xs md:mx-2 md:mb-0">
        Follow us
      </h2>
      <HelpButton
